        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 40, marginBottom: 'clamp(48px,7vw,80px)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <a href="https://www.instagram.com/studio187tattoo" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social">
              ...
              <a href="https://www.facebook.com/studio187tattoo" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer-social">
              ...
              <a href="https://www.tiktok.com/@studio187tattoo" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="footer-social">
