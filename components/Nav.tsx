  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        <nav style={{ display: 'flex', alignItems: 'center', gap: 'clamp(14px,2.2vw,34px)', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
          <Link href="/" style={linkStyle('/')} className="nav-link nav-hide-sm">Home</Link>
          <Link href="/gallery" style={linkStyle('/gallery')} className="nav-link">Work</Link>
          <Link href="/store" style={linkStyle('/store')} className="nav-link">Store</Link>
          <Link href="/artists" style={linkStyle('/artists')} className="nav-link">Artists</Link>
          <Link href="/info" style={linkStyle('/info')} className="nav-link">Info</Link>
      ...
      <style>{`
        @media (max-width: 640px) { .nav-enquire-btn { display: none !important; } }
        @media (max-width: 480px) { .nav-hide-sm { display: none !important; } }
      `}</style>
    </header>
  )
}
